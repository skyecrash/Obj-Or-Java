...
public class LinkedListTester {
  ...
  public void testContains() {
    ...
    list.addToFront(3);
    assertTrue("Element is in list, one node & front", list.contains(3));
    list.addToFront(2);
    assertTrue("Element is in list, two nodes & end", list.contains(3));
    list.addToFront(1);
    assertTrue("Element is in list, three nodes & middle", list.contains(2));
    assertFalse("Element is not in list, three nodes", list.contains(0));
  }
