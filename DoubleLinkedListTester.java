...
public class DoubleLinkedListTester {
  ...
  public void testListIteratorRemove() {
    ...
    assertEquals("Iterator failed to remove last element", new Integer(2), head.getElement());
    assertEquals("Iterator failed to remove last element", new Integer(4), head.getNext().getElement());
